class Admin::CollegesController < Admin::ApplicationController
  ...
  def create
    ...
    if @college.save
      redirect_to(admin_college_path(@college), :notice => 'College was successfully created.')
    else
      render :action => "new"
    end
  end
  ...
  def update
    ...
    if @college.update_attributes(params[:college])
      redirect_to(admin_college_path(@college), :notice => 'College was successfully updated.')
    else
      render :action => "edit"
    end
  end
  ...
  def destroy
    ...
    @college.destroy
    redirect_to(admin_colleges_url, :notice => "College was successfully deleted.")
  end
