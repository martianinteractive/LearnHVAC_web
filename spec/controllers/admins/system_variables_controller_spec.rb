...
describe Admins::SystemVariablesController do
  ...
  describe "PUT :update_status" do
    ...
    it "" do
      xhr(:put, :update_status, :master_scenario_id => @master_scenario.id, :variables_ids => [@system_variable.id])
    ...
    it "should mass disable system variables" do
      ...
      xhr(:put, :update_status, :master_scenario_id => @master_scenario.id, :variables_ids => [v1.id, v2.id, v3.id], :status => 'disable')
    ...
    it "should mass enable system variables" do
      ...
      xhr(:put, :update_status, :master_scenario_id => @master_scenario.id, :variables_ids => [v1.id, v2.id])
