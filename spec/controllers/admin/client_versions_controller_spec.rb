...
describe Admin::ClientVersionsController do
  before(:each) do
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created version" do
        ...
        response.should redirect_to(admin_client_version_path(assigns(:client_version)))
      end
    end
  ...
  describe "PUT update" do    
    describe "with valid params" do      
      ...
      it "redirects to the version" do
        ...
        response.should redirect_to(admin_client_version_path(@client_version))
      end
    end
  ...
  describe "DELETE destroy" do    
    ...
    it "redirects to the client versions index" do
      ...
      response.should redirect_to(admin_client_versions_path)
    end
  end
