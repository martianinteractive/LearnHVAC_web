...
describe Admin::CollegesController do
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created college" do
        ...
        response.should redirect_to(admin_college_url(assigns(:college)))
      end
    end
  end
  ...
  describe "PUT update" do
    describe "with valid params" do      
      ...
      it "redirects to the College" do
        put :update, :id => @college.id, :college => { :value => "EAFIT" }
        response.should redirect_to(admin_college_url(@college))
      end
    end
  end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to colleges#index" do
      ...
      response.should redirect_to(admin_colleges_url)
    end
  end
