...
describe User do
  ...
  it { should have_many(:group_scenarios).through(:group_memberships).dependent(:destroy) }
  it { should have_many(:individual_memberships).dependent(:destroy) }
  it { should have_many(:individual_scenarios).through(:individual_memberships).dependent(:destroy) }
